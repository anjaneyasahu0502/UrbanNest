...
const validateListing = (template) => {
    return (req, res, next) => {
        ...
        if (error) {
            ...
            return res.status(400).render(template, { listing: listingData, error });
        }
        next();
    };
};
...
module.exports = { validateListing, loadListing, isLoggedIn, isListingAuthor, isReviewAuthor, isAdmin };
